...
CLIENT_SECRETS_FILE = "client_secret_272955257602-ijsbm2e2a7n9vu7n1121fei1bp00n5ld.apps.googleusercontent.com.json"
...
def upload_youtube(filePath, title="Test Title", description="Test Description", category='22'):
  ...
  args = argparser.parse_args(['--file', filePath])
...
#   argparser.add_argument("--file", help="Video file to upload", default='sample video.mov')
...
# print upload_youtube(filePath='sample video.mov', title='put title here', description='line1 description\nline2 description')